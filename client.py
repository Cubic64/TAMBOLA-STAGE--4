...
def gameWindow():
    ...
    flashNumberLabel = canvas2.create_text(400,screen_height/2.3, text = "Waiting for other to join...", font = ("Chalkboard SE", 30), fill = "#3c2723")
...
def recievedMsg():
    ...
    numbers = [ str(i) for i in range(91, 91)]
